...
String gambar2="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSHqVxIRS4-YwCHIoH05ax1V3C_5BBUlFxIOq8lijxGfuE-q8aPcg";
String backup;
...
void gantiuser(){
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(title: new Text("Demo Sidebar (DRAWER)")),
      drawer: new Drawer(
        child: new ListView(
          children: <Widget>[
